...
1. Add project rename and guarded delete or recovery flows so local workspace management is not stranded at the test level.
2. Continue recorder/runner hardening only after the project management flows above are more complete.
