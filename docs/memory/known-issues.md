...
- Failure screenshots, browser console messages, and page errors now appear in Results diagnostics, but traces, request-failure logs, network captures, and richer artifact navigation are still absent for some real QA workflows.
